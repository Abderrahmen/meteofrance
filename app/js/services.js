...
angular.module('meteoFranceApp.services', ['ngResource'])
...
//
    ...
    //
    .value('exampleLocations', ['Paris', 'Bordeaux', 'Lyon', 'Nantes', 'Marseille', 'Toulouse', 'Lille', 'Strasbourg'])




    //
    // Register service for meteoFrancemap.com
    //
    ...
    .factory('meteoFranceMap', function ($resource) {
